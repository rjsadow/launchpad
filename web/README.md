...
- [@vitejs/plugin-react][plugin-react] uses [Babel](https://babeljs.io/)
  (or [oxc](https://oxc.rs) when used in [rolldown-vite][rolldown-vite])
  for Fast Refresh
- [@vitejs/plugin-react-swc][plugin-swc] uses [SWC](https://swc.rs/)
  for Fast Refresh

[plugin-react]: https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react
[plugin-swc]: https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react-swc
