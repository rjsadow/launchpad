...
type Config struct {
	...
	// Session recording configuration (optional, off by default)
	SessionRecordingEnabled bool   // Enable session recording hooks
	SessionRecordingDriver  string // Recording driver to use (default: "noop")
}
